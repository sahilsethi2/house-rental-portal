...
public class LocationController {
    ...
    // Endpoint for the Admin to get all locations
    @GetMapping
    ...
    // A separate public endpoint for everyone to use (like in forms)
    @GetMapping("/public")
    public ResponseEntity<List<Location>> getPublicLocations() {
        List<Location> locations = locationService.getAllLocations();
